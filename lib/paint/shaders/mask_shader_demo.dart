...
class MaskShaderDemo extends StatefulWidget {
  const MaskShaderDemo({super.key});

  @override
  State<MaskShaderDemo> createState() => _MaskShaderDemoState();
}

class _MaskShaderDemoState extends State<MaskShaderDemo> {
