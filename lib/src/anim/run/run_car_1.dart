...
class _RunCarState extends State<RunCar> with SingleTickerProviderStateMixin {
  ...
  void _rotate() {
    ...
    lastMatrix.multiply(center);
     lastMatrix.multiply(rotate90);
    // end = end.multiplied(center);
    Matrix4 end = lastMatrix.multiplied(centerBack);
    _matrix.value = end;
    lastMatrix = end;
    ...
    // rotate90Matrix.translate(-50.0, -50.0,);
    // Matrix4 end = lastMatrix.multiplied(rotate90Matrix);
    // end = end.multiplied(translateX);
    // //
    // // _matrix =
